...
Tax exempt parcels owned by city, state, county, or federal governments.

## Summary

This dataset contains information such as parcel ID, serial number, parcel address and tax exempt type. Other parcel data can be found in the [Cadastre](https://gis.utah.gov/products/sgid/cadastre/) index on the SGID.
...
We aggregate parcel data from a variety of county sources. Users should expect some variation in schema, currency, and completeness between counties. Please reach out to [our team](https://gis.utah.gov/contact/) with questions or concerns about this dataset.
